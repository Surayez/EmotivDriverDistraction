...
def run_model(classifier_name, problem, epoch, window_len, stride, binary):
    ...
    if classifier_name == "rocket":
        ...
        run_deep_learning_models(classifier_name, train_data, test_data, output_directory, epoch,
...
if __name__ == "__main__":
    ...
    classifier_names = ["attention_resnet"]
    epoch = 1
    window_len = 40
    stride = 20
    binary = True
    ...
    for classifier_name in classifier_names:
        # Run each Model
        run_model(classifier_name, problem, epoch, window_len, stride, binary)
